...
internal static class FmHelper
{
    ...
    internal static EditorLanguage GetLanguage(string extension)
        => AllowedExtensions.GetValueOrDefault(extension);

    internal static bool CheckExtension(string extension) => AllowedExtensions.ContainsKey(extension);
    ...
    internal static RenderFragment GetIcon(string fileName)
    {
